...
const Sidenav =() => {
  ...
  return (
    <div className='w-1/6 h-full border-r-2 border-zinc-200 p-3'>
      ...
      <nav className='flex flex-col  text-zinc-400 text-xl  gap-1'>
        ...
        <Link  to="/popular" className='hover:bg-[#6556cd] hover:text-white   duration-300 rounded p-3'>
        <i className=" mr-2 ri-bard-fill"></i>Popular</Link>
        <Link  to= "/movies" className='hover:bg-[#6556cd] hover:text-white   duration-300 rounded p-3' >
        <i className=" mr-2 ri-movie-2-fill"></i>Movies</Link>
        <Link  to="/tv"className='hover:bg-[#6556cd] hover:text-white   duration-300 rounded p-3'>
        <i className=" mr-2 ri-tv-2-fill"></i>TV Shows</Link>
        <Link  to="/person" className='hover:bg-[#6556cd] hover:text-white   duration-300 rounded p-3'>
